            ...
            <table id="myTable">
                ...
                <tr class="header">
                    ...
                    <td class="tbld"><a
                            ...
                            data-ID="<?php echo $result['productID']; ?>"><i
...
?>
        ...
        <div id="id02" class="modal">
            ...
            <form class="modal-content animate" method="post" action="../api/productapi.php"
...
?></select>
                    ...
                    <tr class="row">
                        ...
                        <td> <input type="number" id="quantity" min="10" class="subfield" name="avaquantity" value="" />
                        </td>
                    </tr>
                ...
                <button type="submit" class="btns" value="update" style="margin-left:460px; margin-top:50px;"
        ...
        <div id="id04" class="modal">
            ...
            <form class="modal-content animate" style="width:45%;" method="post" action="../api/productapi.php"
                ...
                <input type="hidden" id="modalIdValue" class="subfield" name="id" value="" />
                <p class="text" style="font-size:20px;text-align:center;margin-left:90px;">Do you want to delete
                    this product?</p>

                <div>
                    <button type="button" onclick="document.getElementById('id04').style.display='none'" class="btnss"
                        style="margin-left:11rem;">No</button>

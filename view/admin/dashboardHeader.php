...
<header>
    ...
    <a href="dashboard.php" class="logo"><img src="../images/logo.png" alt="Logo" height="80px" style="margin-left:45px;padding-right:0px;"></a>
    ...
    <div class="header-right">
        ...
        <a href="#contact" style="margin-left:60px;margin-top:-8px;"><img src="../images/logo.png" alt="Logo"

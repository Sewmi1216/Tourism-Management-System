<<<<<<< Updated upstream:view/sign.php
<?php 
session_start()
?>
...
<body>
    ...
    <div class="btn-group">
        ...
        <form action="" method="POST" style="font-color:white;" enctype="multipart/form-data">
            ...
            <div class="b">
                <input type="text" placeholder=" Enter your mobile  number" name="mno"  pattern="^(?:\+94|0)[1-9]\d{8}$" required><br>
            </div>
...
<!-- <script>
      function validateMobileNumber(input) {
        const regex = /^(?:\+94|0)[1-9]\d{8}$/; // Regular expression to match phone number pattern
      ...
      function validateForm() {
        ...
        if (!validateMobileNumber(phone)) {
          alert("Please enter a valid Sri Lankan or foreign mobile number");
          return false;
        }
      }
    </script> -->
...
>>>>>>> Stashed changes:view-tourist/sign.php
</html>
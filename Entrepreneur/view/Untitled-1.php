...
<html>
    <head>
        ...
        <body>
            <div class="header">
                <a href="#"><img src="Travel and Tourism Logo.png" alt="Company logo"></a>
...
<html>
  ...
  <form action="/action_page.php">
    <div class="container">
        <h1>ENTREPRENURE REGISTRATION</h1>
        ...
        <label for="Profile"><b>PROFILE IMAGE</b></label><br>
        <input type="file"  id="myFile" name="filename"><br><br>

        <label for="Doc"><b>LEGAL DOCUMENT</b></label><br>
